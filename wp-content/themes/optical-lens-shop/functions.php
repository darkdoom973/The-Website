...
function optical_lens_shop_activation_notice() {
	...
	echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/lens-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'optical-lens-shop' ) .'</a></span>';
	echo '</div>';
}
...
define('OPTICAL_LENS_SHOP_BUY_NOW',__('https://www.vwthemes.com/products/lens-wordpress-theme','optical-lens-shop'));
...
define('OPTICAL_LENS_SHOP_CREDIT',__('https://www.vwthemes.com/products/free-optical-wordpress-theme','optical-lens-shop'));
define('OPTICAL_LENS_SHOP_THEME_BUNDLE_BUY_NOW',__('https://www.vwthemes.com/products/wp-theme-bundle','optical-lens-shop'));
define('OPTICAL_LENS_SHOP_THEME_BUNDLE_DOC',__('https://preview.vwthemesdemo.com/docs/theme-bundle/','optical-lens-shop'));
...
function optical_lens_shop_sanitize_float( $input ) {
...
add_filter('loop_shop_columns', 'optical_lens_shop_loop_columns');
	...
	function optical_lens_shop_loop_columns() {
		return get_theme_mod( 'optical_lens_shop_products_per_row', 3 );
		// 3 products per row
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'optical_lens_shop_products_per_page' );
function optical_lens_shop_products_per_page( $cols ) {
  	return  get_theme_mod( 'optical_lens_shop_products_per_page',9);
}
