<?php
  ...
  * Slug: swiftstore/tending-product
  * Categories: swiftstore
  */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"60px","bottom":"60px","right":"4.2vw","left":"4.2vw"},"blockGap":"var:preset|spacing|20"},"border":{"width":"0px","style":"none"}},"backgroundColor":"background","className":"","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group has-background-background-color has-background" style="border-style:none;border-width:0px;padding-top:60px;padding-right:4.2vw;padding-bottom:60px;padding-left:4.2vw"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|50"}}},"className":"wp-block-group-heading","layout":{"type":"constrained"}} -->
...
<h2><?php echo esc_html__( 'Trending Products', 'swiftstore' ); ?></h2>
<!-- /wp:heading -->
