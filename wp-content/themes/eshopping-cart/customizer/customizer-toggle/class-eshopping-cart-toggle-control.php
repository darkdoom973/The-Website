 ...
 * @access public
 */
class EShopping_Cart_Toggle_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_style( 'eshopping-cart-toggle-control-styles', get_parent_theme_file_uri( 'customizer/customizer-toggle/toggle.css' ), false, '1.0.0', 'all' );
		wp_enqueue_script( 'eshopping-cart-toggle-control-scripts', get_parent_theme_file_uri( 'customizer/customizer-toggle/toggle.js' ), array( 'jquery' ), '1.0.0', true );
	}
	/**
