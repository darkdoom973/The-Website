...
( function( $ ){
	...
	OPNControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'eshopping-cart-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'eshopping-cart-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'eshopping-cart-control-trigger.' + hook, callback );
	    },
	};
...
( function( $ ){
	...
	OPNCustomizer = {
		...
		_initToggles: function()
		{
			...
			OPNControlTrigger.triggerHook( 'eshopping-cart-toggle-control', api );
