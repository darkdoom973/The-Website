...
OPNCustomizerToggles ['eshopping_cart_above_footer_layout'] = [
		    {
				controls: [    
				'eshopping_cart_above_footer_col1_set',
				'eshopping_cart_above_footer_col2_set',
				'eshopping_cart_above_footer_col3_set',
				'eshopping_cart_footer_col1_texthtml',
				'eshopping_cart_footer_col1_widget_redirect',
	            'eshopping_cart_footer_col1_menu_redirect',
				'eshopping_cart_footer_col1_social_media_redirect',
				'eshopping_cart_above_footer_col2_texthtml',
				'eshopping_cart_above_footer_col2_widget_redirect',
				'eshopping_cart_above_footer_col2_menu_redirect',
				'eshopping_cart_above_footer_col2_social_media_redirect',
				'eshopping_cart_above_footer_col3_texthtml',
				'eshopping_cart_above_footer_col3_widget_redirect',
				'eshopping_cart_above_footer_col3_menu_redirect',
				'eshopping_cart_above_footer_col3_social_media_redirect',
				'eshopping_cart_above_ftr_hgt',
				'eshopping_cart_abv_ftr_botm_brd',
				'eshopping_cart_above_frt_brdr_clr',
				],
			...
			},
           {
...

			{
				...
				callback: function(layout){
					var val = api( 'eshopping_cart_above_footer_col1_set' ).get();
			...
			// col2
			{
				...
				callback: function(layout){
					var val = api( 'eshopping_cart_above_footer_col2_set' ).get();
			...
			// col3
			{
				...
				callback: function(layout){
					var val = api( 'eshopping_cart_above_footer_col3_set' ).get();
...
OPNCustomizerToggles ['eshopping_cart_above_footer_col1_set'] = [
		    {
				controls: [    
				'eshopping_cart_footer_col1_texthtml',
				'eshopping_cart_footer_col1_widget_redirect',
				...
				callback: function(layout){
					var val = api( 'eshopping_cart_above_footer_layout' ).get();
...
OPNCustomizerToggles ['eshopping_cart_above_footer_col2_set'] = [
		    {
				controls: [    
				'eshopping_cart_above_footer_col2_texthtml',
				'eshopping_cart_above_footer_col2_widget_redirect',
...
OPNCustomizerToggles ['eshopping_cart_above_footer_col3_set'] = [
		    {
				controls: [    
				'eshopping_cart_above_footer_col3_texthtml',
				'eshopping_cart_above_footer_col3_widget_redirect',
